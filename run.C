...
vector<Int_t> LHC16l = {
    ...
    259473, 259396, 259395, 259394, 259389, 259388, 259382, 259378, 259342,
    259341, 259340, 259339, 259336, 259334, 259307, 259305, 259303, 259302,
    259274, 259273, 259272, 259271, 259270, 259269, 259264, 259263, 259261,
    259257, 259204, 259164, 259162, 259118, 259117, 259099, 259096, 259091,
    259090, 259088, 258964, 258962};  // for run
vector<Int_t> LHC16o = {
...
vector<Int_t> LHC16p = {264347, 264346, 264345, 264341, 264336, 264312, 264306,
                        264305, 264281, 264279, 264277, 264273, 264267, 264266,
                        264265, 264264, 264262, 264261, 264260, 264259, 264238,
...
vector<Int_t> LHC17l = {
    278216, 278215, 278191, 278189, 278166, 278165, 278164, 278158, 278127,
    278126, 278123, 278122, 277996, 277991, 277989, 277987, 277952, 277930,
    277907, 277904, 277903, 277900, 277899, 277898, 277897, 277876, 277870,
    277848, 277847, 277845, 277842, 277841, 277834, 277805, 277802, 277801,
    277800, 277799, 277795, 277794, 277749, 277747, 277746, 277745, 277725,
    277723, 277722, 277721, 277577, 277576, 277575, 277574, 277537, 277536,
    277534, 277531, 277530, 277479, 277478, 277477, 277476, 277473, 277472,
    277418, 277417, 277416, 277389, 277386, 277385, 277384, 277383, 277360,
    277314, 277312, 277310, 277293, 277262, 277257, 277256, 277197, 277196,
    277194, 277193, 277189, 277188, 277184, 277183, 277182, 277181, 277180,
    277155, 277121, 277117, 277091, 277087, 277082, 277079, 277076, 277073,
    277037, 277017, 277016, 277015, 276972, 276971, 276970, 276969, 276967,
    276920, 276917, 276916, 276762, 276675, 276674, 276672, 276671, 276670,
...
vector<Int_t> LHC17r = {282704, 282703, 282702, 282700, 282677, 282676, 282673,
                        282671, 282670, 282667, 282666, 282651, 282629, 282622,
                        282620, 282618, 282609, 282608, 282607, 282606, 282580,
                        282579, 282575, 282573, 282546, 282545, 282544, 282528};
vector<Int_t> LHC10b = {114931, 115186, 115193, 115393, 115401, 116102, 116288,
                        116402, 116403, 116562, 116571, 116574, 116643, 116645,
                        117048, 117050, 117052, 117053, 117059, 117060, 117063,
                        117092, 117099, 117109, 117112, 117116, 117220, 117222,
                        117054, 117065, 117077, 117086};
#else
// ROOT 5 MODE
const int LHC16k[] = {
    258537, 258499, 258477, 258456, 258454, 258452, 258426, 258393, 258391,
    ...
    //----GRID  MODE-------------------------------------------------
        ...
        if (foption.Contains("LHC16l")) {
            if (ismc) {
                if (foption.Contains("Gen")) {
                    plugin->SetGridDataDir(
                        "/alice/sim/2018/LHC18d8");  // general use
                } else {
                    if (foption.Contains("pass2"))
                        plugin->SetGridDataDir(
                            "/alice/sim/2018/LHC18c6b4");  // resonance injected
        ...
        if (foption.Contains("LHC17k")) {
            if (ismc) {
                plugin->SetGridDataDir(
                    "/alice/sim/2018/LHC18c6a");  // resonance injected
                // plugin->SetGridDataDir("/alice/sim/2017/LHC17d20a1");
                // //general use
                plugin->SetDataPattern("*AliESDs.root");
            } else {
