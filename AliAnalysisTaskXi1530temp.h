...
class AliAnalysisTaskXi1530temp : public AliAnalysisTaskSE {
    public:
        ...
        AliAnalysisTaskXi1530temp();
        AliAnalysisTaskXi1530temp(const char *name, const char *option);
        AliAnalysisTaskXi1530temp(const AliAnalysisTaskXi1530temp& ap);
        AliAnalysisTaskXi1530temp& operator =(const AliAnalysisTaskXi1530temp& ap);
        ~AliAnalysisTaskXi1530temp();
        ...
        void SetTPCNsigXi1530PionCut (Int_t fSysOption, Double_t nXi1530PionCut)  {
            if(fSysOption == 0) fTPCNsigXi1530PionCut = nXi1530PionCut;
            if(fSysOption == 1) fTPCNsigXi1530PionCut_loose = nXi1530PionCut;
            if(fSysOption == 2) fTPCNsigXi1530PionCut_tight = nXi1530PionCut;
            }
        void SetTPCNsigLambdaProtonCut(Int_t fSysOption, Double_t nLambdaProtonCut) {
            if(fSysOption == 0) fTPCNsigLambdaProtonCut = nLambdaProtonCut; 
            if(fSysOption == 1) fTPCNsigLambdaProtonCut_loose = nLambdaProtonCut; 
            if(fSysOption == 2) fTPCNsigLambdaProtonCut_tight = nLambdaProtonCut; 
            }
        void SetTPCNsigLambdaPionCut(Int_t fSysOption, Double_t nLambdaPionCut) {
            if(fSysOption == 0) fTPCNsigLambdaPionCut = nLambdaPionCut; 
            if(fSysOption == 1) fTPCNsigLambdaPionCut_loose = nLambdaPionCut; 
            if(fSysOption == 2) fTPCNsigLambdaPionCut_tight = nLambdaPionCut; 
            }
        void SetTPCNsigBachelorPionCut(Int_t fSysOption, Double_t nBachelorPionCut) { 
            if(fSysOption == 0) fTPCNsigBachelorPionCut = nBachelorPionCut; 
        ...
        void SetXi1530PionZVertexCut(Int_t fSysOption, Double_t nXi1530PionZVertexCut) {
            if(fSysOption == 0) fXi1530PionZVertexCut = nXi1530PionZVertexCut;
            if(fSysOption == 1) fXi1530PionZVertexCut_loose = nXi1530PionZVertexCut;
            if(fSysOption == 2) fXi1530PionZVertexCut_tight = nXi1530PionZVertexCut;
            }
        void SetDCADist_LambdaDaughtersCut(Int_t fSysOption, Double_t nDCADist_LambdaDaughtersCut) {
            if(fSysOption == 0) fDCADist_LambdaDaughtersCut = nDCADist_LambdaDaughtersCut;
            if(fSysOption == 1) fDCADist_LambdaDaughtersCut_loose = nDCADist_LambdaDaughtersCut;
            if(fSysOption == 2) fDCADist_LambdaDaughtersCut_tight = nDCADist_LambdaDaughtersCut;
            }
        void SetDCADist_XiDaughtersCut(Int_t fSysOption, Double_t nDCADist_XiDaughtersCut) {
            if(fSysOption == 0) fDCADist_XiDaughtersCut = nDCADist_XiDaughtersCut;
            if(fSysOption == 1) fDCADist_XiDaughtersCut_loose = nDCADist_XiDaughtersCut;
            if(fSysOption == 2) fDCADist_XiDaughtersCut_tight = nDCADist_XiDaughtersCut;
            }

        void SetDCADist_Lambda_PVCut(Int_t fSysOption, Double_t nDCADist_Lambda_PVCut) {
            if(fSysOption == 0) fDCADist_Lambda_PVCut = nDCADist_Lambda_PVCut;
            if(fSysOption == 1) fDCADist_Lambda_PVCut_loose = nDCADist_Lambda_PVCut;
            if(fSysOption == 2) fDCADist_Lambda_PVCut_tight = nDCADist_Lambda_PVCut;
            }

        void SetV0CosineOfPointingAngleCut(Int_t fSysOption, Double_t nV0CosineOfPointingAngleCut) {
            if(fSysOption == 0) fV0CosineOfPointingAngleCut = nV0CosineOfPointingAngleCut;
            if(fSysOption == 1) fV0CosineOfPointingAngleCut_loose = nV0CosineOfPointingAngleCut;
            if(fSysOption == 2) fV0CosineOfPointingAngleCut_tight = nV0CosineOfPointingAngleCut;
            }
        void SetCascadeCosineOfPointingAngleCut(Int_t fSysOption, Double_t nCascadeCosineOfPointingAngleCut) {
            if(fSysOption == 0) fCascadeCosineOfPointingAngleCut = nCascadeCosineOfPointingAngleCut;
            if(fSysOption == 1) fCascadeCosineOfPointingAngleCut_loose = nCascadeCosineOfPointingAngleCut;
            if(fSysOption == 2) fCascadeCosineOfPointingAngleCut_tight = nCascadeCosineOfPointingAngleCut;
            }
        void SetXiMassWindowCut(Int_t fSysOption, Double_t nXiMassWindowCut) {
            if(fSysOption == 0) fXiMassWindowCut = nXiMassWindowCut;
            if(fSysOption == 1) fXiMassWindowCut_loose = nXiMassWindowCut;
            if(fSysOption == 2) fXiMassWindowCut_tight = nXiMassWindowCut;
            }
    ...
    private:
        ...
        Double_t PVz = 999;
        Double_t bField = 999;
        ClassDef(AliAnalysisTaskXi1530temp, 7);
        //1: Frist version
