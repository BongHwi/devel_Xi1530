...
inputGenMCdata = "AnalysisResults_Xi1530LHC16kl_pass2_GenMC_SYS_train.root"
...
def submit(args):
	...
	command = """echo 'TGrid::Connect(\"alien://\");gGrid->Cd(\"""" + workdirectory + """\");gGrid->Command(\"submit extract.jdl """ + options + """\");' | root -b -l | grep -v Welcome | grep -v Trying """
